                                                        ...
                                                        <asp:GridView ID="gvPackages" runat="server" ShowFooter="false" DataKeyNames="id_num"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Service Type" Visible="false">
                                                                    ...
                                                                    <ItemTemplate>
                                                                        <asp:Label runat="server" ID="lblServiceTypeFx" Text='<%# (FedExShippingWCF.ShippingServiceType)Enum.Parse(typeof(FedExShippingWCF.ShippingServiceType), Eval("service_type_fx").ToString()) %>' Font-Size="Smaller" />
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
